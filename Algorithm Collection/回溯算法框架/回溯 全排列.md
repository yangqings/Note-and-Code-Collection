...
![backtrace](G:\MyFile Master\6.Demo\MyNote\DSA\pic\backtrace.jpg)
...
![backtrace1](G:\MyFile Master\6.Demo\MyNote\DSA\pic\backtrace1.jpg)
...
{
	/* '.'空 ；'Q'皇后 */
    vector<vector<string>> board(n, string(n,'.'));
    backtrack(board, 0);
    return res;
}
